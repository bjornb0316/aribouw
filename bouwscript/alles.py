# -*- coding: utf-8 -*-
"""Bouwt beide varianten.

  variant-grondlaag/  Professional: de verzorgde bedrijfssite
  variant-aflak/      Performance: kleurkiezer, voor-en-na, aanvraag in
                      stappen, dienst- en plaatspagina's, kleurvlakken
...
def main():
    ...
    pagina = [
        ("index.html", P1.index("grondlaag")),
        ("diensten.html", P1.diensten("grondlaag")),
        ("werk.html", P1.werk("grondlaag")),
